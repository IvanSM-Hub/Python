...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\isario\OneDrive - Esden Business School\Ivan\python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\isario\OneDrive - Esden Business School\Ivan\python\venv\Scripts\deactivate.nu'
